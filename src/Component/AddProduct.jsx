  ...
  function SubmitForm(e) {
    ...
    fetch(`https://admin-c2bb8-default-rtdb.firebaseio.com/product.json`, {
      ...
      .then((json) => {
        ...
        setFormData({ ProductName: "", ProductCatgory: "", ProductImage: "" });
        Swal.fire("Category!", "Category added successfully!", "success");
      });
  }
        ...
        >
          ...
          <li className="nav-item">
            ...
            >
              <div className="bg-white py-2 collapse-inner rounded">
                ...
                <Link className="collapse-item" to="/ManageCategories_db">
          ...
          <li className="nav-item">
            <a
              ...
              href="#"
              data-toggle="collapse"
              data-target="#collapseNew1"
              aria-expanded="true"
              aria-controls="collapseNew1"
            >
              <i className="fas fa-fw fa-cog" />
              <span>Product</span>
            </a>
            ...
            >
              <div className="bg-white py-2 collapse-inner rounded">
                ...
                <Link className="collapse-item" to="/ManageProduct">
                  Manage Product
                </Link>
              </div>
            </div>
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
            ...
            <div className="container-fluid">
              {/* Page Heading */}
              <h1 className="h3 mb-4 text-gray-800">Customer Details</h1>
              ...
              <form>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    id="ProductCategory"
                    value={formvalue.ProductCatgory}
                    onChange={FormData}
